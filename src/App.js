...
function App() {
  return (
    <div className="m-[3vw] border-blue-950 border-4">
      ...
      <Link to="/" className='bg-blue-600 p-[5px] text-white m-[5px] hover:bg-blue-800'>Home</Link> | <Link to="/play" className='bg-blue-600 p-[5px] text-white m-[5px] hover:bg-blue-800'>Play</Link> | <Link to="/upload" className='bg-blue-600 p-[5px] text-white m-[5px] hover:bg-blue-800'>Upload</Link> | <Link to="/secure-upload" className='bg-blue-600 p-[5px] text-white m-[5px] hover:bg-blue-800'>Secure Upload</Link> 
      <br/>
      <br/>
      <Outlet/>
    </div>
